...
function Clima({ data }) {
  ...
  return (
    ...
    <div className="card mt-3">
      <h3 className="card-header size-title">La temperatura en <span className="font-weight-bold text-info ">{name}</span> es:</h3>
      <div className="card-body">
        ...
        <div className="card-footer text-center text-info humedad size-min-max"> Velocidad del viento: {wind.speed} m/s</div>
